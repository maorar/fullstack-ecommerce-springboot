package com.icei.ecommerce.config;

import com.icei.ecommerce.entity.Country;
import com.icei.ecommerce.entity.Product;
import com.icei.ecommerce.entity.ProductCategory;
import com.icei.ecommerce.entity.State;
...
public class MyDataRestConfig implements RepositoryRestConfigurer {
    ...
    private void exposeIds(RepositoryRestConfiguration config) {
        //expose entity ids
        //
        // - get a list of all entity ids from the entity manager
